...
var url_encode__delegate = function (s,p__11707){var vec__11709 = p__11707;var encoding = cljs.core.nth.call(null,vec__11709,(0),null);if(cljs.core.truth_(s))
...
return url_encode__delegate.call(this,s,p__11707);};
url_encode.cljs$lang$maxFixedArity = 1;
url_encode.cljs$lang$applyTo = (function (arglist__11710){
var s = cljs.core.first(arglist__11710);
var p__11707 = cljs.core.rest(arglist__11710);
return url_encode__delegate(s,p__11707);
});
...
var url_decode__delegate = function (s,p__11711){var vec__11713 = p__11711;var encoding = cljs.core.nth.call(null,vec__11713,(0),null);if(cljs.core.truth_(s))
...
return url_decode__delegate.call(this,s,p__11711);};
url_decode.cljs$lang$maxFixedArity = 1;
url_decode.cljs$lang$applyTo = (function (arglist__11714){
var s = cljs.core.first(arglist__11714);
var p__11711 = cljs.core.rest(arglist__11714);
return url_decode__delegate(s,p__11711);
});
...
{var G__11717 = clojure.string.upper_case.call(null,unit);switch (G__11717) {
default:
var G__11718 = unit;switch (G__11718) {
case "M":
...
*/
no.en.core.parse_integer = (function parse_integer(s){return no.en.core.parse_number.call(null,s,(function (p1__11721_SHARP_){return parseInt(p1__11721_SHARP_);
}));
});
/**
* Parse `s` as a long number.
*/
no.en.core.parse_long = (function parse_long(s){return no.en.core.parse_number.call(null,s,(function (p1__11722_SHARP_){return parseInt(p1__11722_SHARP_);
}));
});
/**
* Parse `s` as a double number.
*/
no.en.core.parse_double = (function parse_double(s){return no.en.core.parse_number.call(null,s,(function (p1__11723_SHARP_){return parseFloat(p1__11723_SHARP_);
}));
});
/**
* Parse `s` as a float number.
*/
no.en.core.parse_float = (function parse_float(s){return no.en.core.parse_number.call(null,s,(function (p1__11724_SHARP_){return parseFloat(p1__11724_SHARP_);
}));
});
/**
* Format the map `m` into a query parameter string.
*/
no.en.core.format_query_params = (function format_query_params(m){return clojure.string.join.call(null,"&",cljs.core.map.call(null,(function (p1__11726_SHARP_){return clojure.string.join.call(null,"=",p1__11726_SHARP_);
}),cljs.core.map.call(null,(function (p1__11725_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[no.en.core.url_encode.call(null,cljs.core.name.call(null,cljs.core.first.call(null,p1__11725_SHARP_))),no.en.core.url_encode.call(null,cljs.core.second.call(null,p1__11725_SHARP_))],null));
}),cljs.core.seq.call(null,m))));
});
/**
* Format the Ring map as an url.
*/
no.en.core.format_url = (function format_url(m){return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,new cljs.core.Keyword(null,"scheme","scheme",90199613).cljs$core$IFn$_invoke$arity$1(m)))+"://"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var map__11728 = m;var map__11728__$1 = ((cljs.core.seq_QMARK_.call(null,map__11728))?cljs.core.apply.call(null,cljs.core.hash_map,map__11728):map__11728);var password = cljs.core.get.call(null,map__11728__$1,new cljs.core.Keyword(null,"password","password",417022471));var user = cljs.core.get.call(null,map__11728__$1,new cljs.core.Keyword(null,"user","user",1532431356));if(cljs.core.truth_(user))
...
{return cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.mapcat.call(null,(function (p1__11731_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.keyword.call(null,no.en.core.url_decode.call(null,cljs.core.first.call(null,p1__11731_SHARP_))),no.en.core.url_decode.call(null,cljs.core.second.call(null,p1__11731_SHARP_))],null));
}),cljs.core.filter.call(null,(function (p1__11730_SHARP_){return cljs.core._EQ_.call(null,(2),cljs.core.count.call(null,p1__11730_SHARP_));
}),cljs.core.map.call(null,(function (p1__11729_SHARP_){return clojure.string.split.call(null,p1__11729_SHARP_,/=/);
...
}catch (e11733){if((e11733 instanceof Error))
{var e = e11733;if((n__$1 === (0)))
{throw e;
} else
{return null;
}
