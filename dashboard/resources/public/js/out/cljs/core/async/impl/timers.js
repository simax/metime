...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4161__auto__,writer__4162__auto__,opt__4163__auto__){return cljs.core._write.call(null,writer__4162__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_14935 = (0);while(true){
if((i_14935 < arr.length))
{(arr[i_14935] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4161__auto__,writer__4162__auto__,opt__4163__auto__){return cljs.core._write.call(null,writer__4162__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_14942 = (self__.level + (1));while(true){
if((i_14942 <= (new_level + (1))))
{(update[i_14942] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14944 = (0);while(true){
if((i_14944 <= self__.level))
{var links_14945 = (update[i_14944]).forward;if(((links_14945[i_14944]) === x__$1))
{(links_14945[i_14944] = (x__$1.forward[i_14944]));
{
var G__14946 = (i_14944 + (1));
i_14944 = G__14946;
continue;
}
} else
{{
var G__14947 = (i_14944 + (1));
i_14944 = G__14947;
continue;
}
}
