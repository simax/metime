...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15028 = (0);while(true){
var m_15029 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15029 == null))
{} else
{m_15029.call(null);
if((count_15028 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15030 = (count_15028 + (1));
count_15028 = G__15030;
continue;
}
} else
{}
